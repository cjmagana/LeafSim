find_path(MINUIT2_INCLUDE_DIR Minuit2/MnUserFcn.h
          HINTS $ENV{HOME}/local/include $ENV{HOME}/include $ENV{ROOTSYS}/include/root)

find_library(MINUIT2_LIBRARY NAMES Minuit2
             HINTS $ENV{HOME}/local/lib $ENV{HOME}/lib $ENV{ROOTSYS}/lib/root)

set (MINUIT2_LIBRARIES ${MINUIT2_LIBRARY})

if (MINUIT2_INCLUDE_DIR MATCHES $ENV{ROOTSYS}/include/root)
...
endif (MINUIT2_INCLUDE_DIR MATCHES $ENV{ROOTSYS}/include/root)
